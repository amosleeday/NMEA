...
extern void SolveNormalEquationCholesky2(math::matrix<double>& N1,math::matrix<double>& N12,math::matrix<double>& N2,math::matrix<double>& U1,math::matrix<double>& U2);
