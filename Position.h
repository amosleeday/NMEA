...
public:	
	...
	void FormDesMatIono(math::matrix<double>& DesMatIono,DdData dddata,int numCod,int numPhs,double* freqCod,double* freqPhs);
	...
	void ChangePredataByNewRef(DdData& predddata,int newRef);
	...
	void FormResidual(math::matrix<double>& L,DdData dddata,int numCod,int numPhs);
...
//	void ComObsPhs(DdCtrl& ddctrl,DdData& temp,DdData dddata,DdObsInfo& ddobsinfo);
	...
	void ComObsPhs(DdCtrl& ddctrl,DdData& temp,DdData dddata);
	...
	void ReFormConstWithAmb(math::matrix<double>& L, DdAmbInfo ambinfo,int numCod,int TypePhsNo,double* freqPhs,DdData dddata);
	...
	int FormDesMatAmb(math::matrix<double>& DesMatAmb,DdData dddata,int numPhs,int numCod,double*freqPhs,DdAmbInfo ambinfo);
